...
and we want to keep it that way to maintain ownership and control.

**Changes partially assisted by AI tools are allowed with conditions**.
Using AI to ask questions, research, and to catch minor errors or fix typos
before submitting a PR is allowed and does not require notice.
...
they were generated. You should always review AI generated changes, and make
sure that they don't introduce any bugs, or reduce the quality of the code.
